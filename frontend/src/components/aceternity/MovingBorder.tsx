...
export function Button({
	...
	return (
		<Component
			className={cn(
				"relative h-12 w-full overflow-hidden bg-transparent p-[1px] text-xl cursor-pointer",
				containerClassName,
			)}
			style={{
		...
		>
			...
			>
				<MovingBorder duration={duration} rx="30%" ry="30%">
					<div
						className={cn(
							"h-20 w-20 bg-[radial-gradient(#FF79C6_40%,transparent_60%)] opacity-[0.8]",
							borderClassName,
						)}
					/>
				</MovingBorder>
			...
			<div
				className={cn(
					"relative flex h-full w-full items-center justify-center border border-[#FF79C6]/20 bg-black text-sm text-white antialiased backdrop-blur-xl",
					className,
				)}
				style={{
